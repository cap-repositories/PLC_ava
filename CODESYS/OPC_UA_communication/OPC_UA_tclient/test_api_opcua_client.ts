...
const endpointUrl = "opc.tcp://DESKTOP-JT4NILH:4334";
...
async function main() {
    try {
      ...
      const dataValue2 = await session.readVariableValue("s=London-Temperature");
